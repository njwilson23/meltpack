...
C---------------------------------------------
      ...
      integer   imgptr, line, lncont, lnstrt, memptr,
     .          ncol,  ndxout, nrow
...
C-------------------------------------------------
      ...
      do line = 1,memdim(2)
        ...
        if (lncont.lt.lnstrt) then
            do memptr=lncont,lnstrt-1
              membfs(memptr) = 0.0
            end do
        end if
      end do
C
C  Make complex 2-d of search data
C--------------------------------
      memptr = 1
      do i = 1, memdim(2)
        do j = 1, memdim(1)
...
C
C  Make complex 2-d of reference data
C----------------------------------
      memptr = 1
      do i = 1, memdim(2)
        do j = 1, memdim(1)
